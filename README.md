...
2. **Nothing to install.** The terminal is fine for the commands in the [cheatsheet](docs/terminal.md). But no npm, no Node, no downloading packages — if Claude tells you to install something, say *"do it without installing anything"*.
...
5. **Commit at the end of every day.** [Two minutes, three buttons](docs/saving-your-work.md).
